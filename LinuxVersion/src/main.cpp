...
int main(int argc, char *argv[]) 
{
	...
	if (success)
	{
		...
		while (!close_requested)
		{
            ...
            auto playerPosition = PlayerObject.getDest();
            auto ballrPosition = BallObject.getDest();
            auto aiPlayerPosition = AIPlayerObject.getDest();

			// draw the window
            SDL_RenderCopy(AirHockeyMain.getRenderer(), AirHockeyMain.getTexture("Arena"), nullptr, &Arena);
            SDL_RenderCopy(AirHockeyMain.getRenderer(), AirHockeyMain.getTexture("ScorePanel"), nullptr, &ScorePanelRect);
            SDL_RenderCopy(AirHockeyMain.getRenderer(), AirHockeyMain.getTexture("Player"), nullptr, &playerPosition);
            SDL_RenderCopy(AirHockeyMain.getRenderer(), AirHockeyMain.getTexture("AI"), nullptr, &aiPlayerPosition);
            SDL_RenderCopy(AirHockeyMain.getRenderer(), AirHockeyMain.getTexture("PlayerScore"), nullptr, &PlayerScore);
            SDL_RenderCopy(AirHockeyMain.getRenderer(), AirHockeyMain.getTexture("AIScore"), nullptr, &AIScore);
            SDL_RenderCopy(AirHockeyMain.getRenderer(), AirHockeyMain.getTexture("Ball"), nullptr, &ballrPosition);
